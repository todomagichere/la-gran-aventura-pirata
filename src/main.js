...
root.innerHTML = `
  ...
  <section class="welcome-curtain" id="welcome-curtain" role="dialog" aria-modal="true" aria-labelledby="welcome-title">
    ...
    <div class="welcome-curtain__message"><span aria-hidden="true">☠</span><p>MENSAJE PARA LA TRIPULACIÓN</p><h1 id="welcome-title">¡BIENVENIDOS A<br>LA GRAN AVENTURA PIRATA!</h1><button id="welcome-continue" type="button">HAZ CLIC PARA CONTINUAR <b aria-hidden="true">→</b></button></div>
  </section>
